...
class Email
{
	...
	/* public function SendEmail($template_name,$data_replace,$to,$from,$from_name,$subject)
	{
		require_once("phpmail/class.phpmailer.php");
			$mail = new PHPMailer();
				...
				$mail->Username   = 'admin@keyverticals.com'; // SMTP account username
				$mail->Password   = 'admin123$';        // SMTP account password	
				$mail->SetFrom('admin@keyverticals.com','Key Verticals');
				$mail->AddAddress($to);
